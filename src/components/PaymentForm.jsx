...
import { clearCart } from "../store/slices/cartSlice"; // check is this need?
...
const PaymentForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const cardElement = elements.getElement(CardElement);     // payment error zone from cardElement must in capitalized.
