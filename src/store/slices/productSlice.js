  ...
  extraReducers: (builder) => {
    builder.addCase(fetchAllProducts.pending, (state) => {
      ...
      .addCase(fetchProductDetails.fulfilled, (state, action) => {
        ...
        state.productReviews = action.payload.reviews;    //productReviews
      ...
      .addCase(postReview.fulfilled, (state, action) => {
        ...
        if (existingReviewIndex !== -1) {
          state.productReviews[existingReviewIndex].ratings = Number(
            newReview.rating    //check is rating or ratings
          );
      ...
      .addCase(deleteReview.fulfilled, (state, action) => {
        ...
        state.productReviews = state.productReviews.filter((review) => review.review_id !== action.payload);    // review.reviewId
      })
