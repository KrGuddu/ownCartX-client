          ...
          <div className="glass-card p-4 mb-8">
            <div className="flex items-center space-x-4 flex-wrap">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium">Filter by ststus:</span>
              </div>
                ...
                return (
                  <div key={order.id} className="glass-card p-6">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 space-y-4 md:space-y-0">
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <span
                            className={`px-3 py-1 rounded text-sm font-medium capitalize ${getStatusColor(order.order_status)}`}
                          >
                            {order.order_status}
                          </span>
                        </div>
                    ...
                    <div className="flex flex-wrap gap-3 mt-6 pt-6 border-t border-[hsla(var(--glass-border))]">
                      ...
                      {/* Avi cancel order funcionality nhi hai to ek bar order krne par cancel nhi ho payega isilye isse commit kiya gya hai.  */}
                    </div>
                  </div>
                );
              })}
