...
const Payment = () => {
  ...
  useEffect(() => {
    loadStripe(import.meta.env.VITE_STRIPE_FRONTEND_KEY) // enter here stripe key
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center space-x-4 mb-8">
              <Link
                to={"/cart"}
                className="p-2 glass-card hover:glass-on-hover animate-smooth"
              >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        >
                          ...
                          <option value="Uttarpradesh">Uttarpradesh (U.P.)</option>
                          <option value="Madhyapradesh">Madhyapradesh (MP)</option>
                          <option value="Jharkhand">Jharkhand (JK)</option>
                          <option value="Punjab">Punjab (PB)</option>
                          <option value="Delhi">Jammu and Kashmir (JK)</option>
                          <option value="West Bengal">West Bengal (WB)</option>
                          <option value="Mumbai">Maharashtra (MH)</option>
                          <option value="Delhi">Andhra Pradesh (AP)</option>
                          <option value="Delhi">Haryana (HR)</option>
                          <option value="Delhi">Gujarat (GJ)</option>
                        </select>
                      </div>
